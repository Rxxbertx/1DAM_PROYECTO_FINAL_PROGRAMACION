...
public class Prueba extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Prueba() {Border innerBorder1 = BorderFactory.createLineBorder(Color.WHITE, 3);
	...
	renderizadoDeCeldaComboBox render = new renderizadoDeCeldaComboBox();
	render.setPreferredSize(new Dimension(200, 130));
	comboJuegos.setRenderer(render);
